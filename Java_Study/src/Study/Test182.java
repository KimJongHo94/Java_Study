...
○ Serializable 인터페이스
  ...
  또한, 인터페이스와 달리 구현해야 할 메소드가 없기 때문에
  단지 선언만 해주면 된다.
...
public class Test182 {
	...
	public static void main(String[] args) throws Exception {
		...
		//   구성하겠다는 의미
		//-- 결과적으로 [ C:\Users\pc\Desktop\Study\data\test.ser ] 구성.
