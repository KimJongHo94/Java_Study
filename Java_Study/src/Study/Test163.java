...
○ Vector(벡터)
  ...
  JDK 1.5 이전에는 자바 기본형 데이터를 저장할 수 없었으나
  ...
  - E set(int index, E element)
	...
	주어진 위치에 저장되어 있던 객체는 소멸된다. (→ 덮어쓰기의 개념)
...
public class Test163 {
	...
	public static void main(String[] args) {
		...
		// [ next() ]    : 다음 데이터 요소를 직접적으로 변환

		Iterator<Object> it = v.iterator();		// 반환하는 타입이 Iterator 타입
		
		while(it.hasNext())
		{
			str = (String)it.next();
			System.out.print(str + " ");
			// 검정 노랑 초록 파랑 빨강 연두 하얀
