...
○ Hashtable<K, V> 클래스
  ...
  - 또한, Hashtable 클래스는 key 또는 value 값으로 null 을 허용하지 않는다.
...
public class Test175 {
	...
	public static void main(String[] args) {
		...
		// ht 라는 Hashtalbe 자료구조에서
		// [ 진영은 ] 데이터 삭제
		// → remove()
		ht.remove("진영은");
		// 키 값이 가지고 있는 value 값 까지 같이 삭제
		...
		System.out.println();
		//--==>> 010-1234-1234
		//-- 기존 "010-3441-0260" 에서 "010-1234-1234" 로 변경되었음을 확인
		//   (덮어쓰기 개념)
